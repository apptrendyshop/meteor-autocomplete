...
View = (function() {
  ...
  View.prototype.reposition = function(rect) {
    var contentOptions, _window, offset, overflowOffset, ref;
    console.log('this is the escope', this.context);
    if (this.context.app.iframeAsRoot) {
      _window = this.context.app.window;
    } else if (this.context.setting && this.context.setting.content) {
      _window = this.context.setting.content;
    } else {
      _window = window;
    }
